...
>
> **Technology simplification:** Hydro = zero (max elevation 2.4m). Wind = marginal (4.5–6.2 m/s, only 4 islands >6 m/s, salt corrosion). Simplified to **4 technologies**: grid extension, solar+battery, diesel, solar-diesel hybrid.
>
> **Scenario structure:** S1 (BAU Diesel), S2 (Full Integration / India Cable), S3 (National Grid), S4 (Islanded Green), S5 (Near-Shore Solar), S6 (Maximum RE), S7 (LNG Transition). See SCENARIO_GUIDE.md for full details.
